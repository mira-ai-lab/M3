...
def evaluate_glm_on_hate_meme(
    ...
    df.to_csv("eval/results/binary_predictions_glm_img.csv", index=False, encoding="utf-8-sig") # 改为自己的路径
    ...
    with open("eval/results/binary_evaluation_glm_img.json", "w", encoding="utf-8") as f: # 改为自己的路径
