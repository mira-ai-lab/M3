...
def evaluate_glm_on_meme_explanation(
    ...
    df.to_csv("eval/results/reason_predictions_GLM_img.csv", index=False, encoding="utf-8-sig")
    ...
    with open("eval/results/reason_evaluation_GLM_img.json", "w", encoding="utf-8") as f:
