...
def evaluate_glm_on_category_multilabel(
    ...
    df.to_csv("eval/results/category_predictions_glm.csv", index=False, encoding="utf-8-sig")
    ...
    with open("eval/results/category_evaluation_glm.json", "w", encoding="utf-8") as f:
