...
def evaluate_llava_on_hate_meme(
    ...
    df.to_csv("eval/results/binary_predictions_llava13B.csv", index=False, encoding="utf-8-sig")
    ...
    with open("eval/results/binary_evaluation_llava13B.json", "w", encoding="utf-8") as f:
