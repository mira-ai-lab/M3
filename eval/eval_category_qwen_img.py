...
def evaluate_qwen2_5_vl_on_category_multilabel(
    ...
    df.to_csv("eval/results/category_predictions_qwen8B_img.csv", index=False, encoding="utf-8-sig")
    ...
    with open("eval/results/category_evaluation_qwen8B_img.json", "w", encoding="utf-8") as f:
