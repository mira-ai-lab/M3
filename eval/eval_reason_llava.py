...
def evaluate_llava_on_meme_explanation(
    ...
    df.to_csv("eval/results/reason_predictions_llava13B.csv", index=False, encoding="utf-8-sig")
    ...
    with open("eval/results/reason_evaluation_llava13B.json", "w", encoding="utf-8") as f:
