...
def evaluate_llava_on_category_multilabel(
    ...
    df.to_csv("eval/results/category_predictions_llava13B.csv", index=False, encoding="utf-8-sig")
    ...
    with open("eval/results/category_evaluation_llava13B.json", "w", encoding="utf-8") as f:
