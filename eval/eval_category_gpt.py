...
def evaluate_gpt_on_category_multilabel(
    ...
    df.to_csv("eval/results/category_predictions_gpt4o.csv", index=False, encoding="utf-8-sig")
    ...
    with open("eval/results/category_evaluation_gpt4o.json", "w", encoding="utf-8") as f:
        json.dump(metrics, f, ensure_ascii=False, indent=4)

if __name__ == "__main__":
    evaluate_gpt_on_category_multilabel(
        "datasets/CHEM_hate.json", 
        "datasets/img"
    ) 