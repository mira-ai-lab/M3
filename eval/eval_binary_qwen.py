...
def evaluate_qwen2_5_vl_on_hate_meme(
    ...
    df.to_csv("eval/results/binary_predictions_qwen8B.csv", index=False, encoding="utf-8-sig")
    ...
    with open("eval/results/binary_evaluation_qwen8B.json", "w", encoding="utf-8") as f:
        json.dump(metrics, f, ensure_ascii=False, indent=4)

    # 不再返回任何结果

if __name__ == "__main__":
    evaluate_qwen2_5_vl_on_hate_meme("dataset/CHEM.json", "dataset/img", "eval/model/Qwen3-VL-8B-Instruct") # 可更换Qwen2.5-VL-3B-Instruct