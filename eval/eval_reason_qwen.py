...
def evaluate_qwen2_5_vl_on_meme_explanation(
    ...
    for item in tqdm(data):
        ...
        results_list.append({
            ...
            "rouge_l": rouge_l_f,
            "bert_f1": bert_f1,
            "aspect_bert_score": aspect_bert_coverage,
    ...
    df.to_csv("eval/results/reason_predictions_qwen8B.csv", index=False, encoding="utf-8-sig")
    ...
    with open("eval/results/reason_evaluation_qwen8B.json", "w", encoding="utf-8") as f:
