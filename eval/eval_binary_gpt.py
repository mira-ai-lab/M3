...
def evaluate_gpt_on_hate_meme(
    ...
    df.to_csv("eval/results/binary_predictions_got4o.csv", index=False, encoding="utf-8-sig")
    ...
    with open("eval/results/binary_evaluation_gpt4o.json", "w", encoding="utf-8") as f:
        json.dump(metrics, f, ensure_ascii=False, indent=4)

if __name__ == "__main__":
    evaluate_gpt_on_hate_meme("dataset/CHEM.json", "dataset/img") 